...
public class DataProvider {
    ...
    static {
        ...
        data.add(new Vehicle("Lowe", 2010, "120hp", getRandomDate(),"34234262626"));
        data.add(new Vehicle("Yamaha", 2010, "125cc", getRandomDate(),"34234262626"));

        data.get(0).getItems().add(new VehicleItem("Engine Oil", "10-W30", "Synthetic Only"));
        data.get(0).getItems().add(new VehicleItem("Oil Filter", "Part # 348427B", "2.5 in."));
        data.get(0).getItems().add(new VehicleItem("Fan Belt", "Part # 642704", "45\" x 3\""));
        data.get(0).getItems().add(new VehicleItem("Headlights", "HLB 345B", "4.5 amps"));
        data.get(0).getItems().add(new VehicleItem("Tires", "Goodyear 345Vs ", "34\", 35psi"));
    }
